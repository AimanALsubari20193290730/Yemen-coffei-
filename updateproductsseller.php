...
$sql = "SELECT prod_id,prod_name,prod_price,prod_quntity,prod_img,prod_des FROM productseller_tb where prod_id=$id";
...
<form action="admin/updateproductssellerdb.php" method="post" enctype="multipart/form-data" class="forr" >
  

  <div class="container">
  
     <label for="email"><b> Id of product</b></label>
    <input class="lo" type="text" readonly placeholder="Enter product name" name="prod_id" value="<?php echo $id; ?>" required>
